            ...
            <section className="testimonials-section py-5">
                <Container>
                    <motion.div 
                        ...
                        variants={fadeIn}
                    >
                        <h2 className="section-title text-center">Ce qu'en disent nos joueurs</h2>
                        <div className="separator mx-auto"></div>
                        ...
                        <Row className="mt-5">
                            <Col md={4} className="mb-4">
                                <div className="testimonial-card">
                                    <div className="testimonial-content">
                                        <p>"Une expérience incroyable ! Les énigmes sont bien pensées et l'ambiance est vraiment immersive. On a adoré !"</p>
                                    </div>
                                    <div className="testimonial-author">
                                        <div className="testimonial-avatar">
                                            <img src="/images/avatar1.jpg" alt="Sophie L." />
                                        </div>
                            ...
                            <Col md={4} className="mb-4">
                                <div className="testimonial-card">
                                    <div className="testimonial-content">
                                        <p>"Nous avons testé l'Escape Game à domicile pour un anniversaire, c'était parfait ! Tout est bien expliqué et les défis sont accessibles."</p>
                                    </div>
                                    <div className="testimonial-author">
                                        <div className="testimonial-avatar">
                                            <img src="/images/avatar2.jpg" alt="Marc T." />
                                        </div>
                                        <div className="testimonial-info">
                                            <h5>Marc T.</h5>
                                            <p>L'Atelier des Engrenages</p>
                                        </div>
                                    </div>
                                </div>
                            </Col>
                            ...
                            <Col md={4} className="mb-4">
                                <div className="testimonial-card">
                                    <div className="testimonial-content">
                                        <p>"Des décors magnifiques, des énigmes originales et un personnel attentionné. Que demander de plus ? Nous reviendrons !"</p>
                                    </div>
                                    <div className="testimonial-author">
                                        <div className="testimonial-avatar">
                                            <img src="/images/avatar3.jpg" alt="Julie et Thomas" />
                                        </div>
                                        <div className="testimonial-info">
                                            <h5>Julie et Thomas</h5>
                                            <p>La Quête du Jedi</p>
                                        </div>
                                    </div>
                                </div>
                            </Col>

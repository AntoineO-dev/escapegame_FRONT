...
const TronePage = () => {
    ...
    const escapeGame = {
        ...
        houses: [
            { name: 'Stark', trait: 'Honneur et persévérance', icon: 'wolf' },
            { name: 'Lannister', trait: 'Richesse et influence', icon: 'lion' },
            { name: 'Targaryen', trait: 'Pouvoir et ambition', icon: 'dragon' },
            { name: 'Baratheon', trait: 'Force et détermination', icon: 'stag' }
        ]
    };
                            ...
                            {escapeGame.houses.map((house, index) => (
                                <Col md={3} sm={6} className="mb-4" key={index}>
                                    <Card className="house-card text-center h-100">
                                        <div className={`house-icon house-icon-${house.icon}`}>
                                            {/* Ici vous pourriez ajouter des icônes SVG des blasons */}
                                        </div>
                                        <Card.Body>
